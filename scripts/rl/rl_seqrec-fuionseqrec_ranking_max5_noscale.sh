...
DATASET=Instruments
OUTPUT_DIR=ckpt/$DATASET/llava_rl_seqrec-fusionseqrec_ranking_max5_noscale
DATA_PATH=./data

export WANDB_NAME=llava_rl_seqrec-fusionseqrec_ranking_max5_noscale
INDEX_FILE=.index_qwen7B.json
TASK=seqrec,fusionseqrec
