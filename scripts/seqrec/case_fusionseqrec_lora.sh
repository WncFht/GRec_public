...
# CKPT_PATH=/opt/meituan/dolphinfs_zhangkangning02/zkn/verl/checkpoints/grec_verl/qwen2-vl-7b-n32/global_step_165/actor/merged
# CKPT_PATH=ckpt/Instruments/Qwen2-VL-7B-lora-item2index-seqrec-fusionseqrec-1-qwen7B-merged-old
CKPT_PATH=./ckpt/base_model/Qwen2-VL-7B-Instruct
