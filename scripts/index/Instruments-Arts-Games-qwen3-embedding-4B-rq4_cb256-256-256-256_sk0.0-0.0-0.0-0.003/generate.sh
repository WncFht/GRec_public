...
: "${CKPT_PATH:=/mnt/dolphinfs/hdd_pool/docker/user/hadoop-hmart-poistar/fanghaotian/GRec/index_train_runs/Instruments-Arts-Games/index/qwen3-embedding-4B/rq4_cb256-256-256-256_sk0.0-0.0-0.0-0.003_kmtrue-lkmtrue-kmi100/run_time/best_collision_model.pth}"
if [[ -z "$CKPT_PATH" ]]; then
