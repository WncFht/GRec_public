...
: "${CKPT_PATH:=/mnt/dolphinfs/hdd_pool/docker/user/hadoop-hmart-poistar/fanghaotian/GRec/index_train_runs/Instruments-Arts-Games/index/qwen3-embedding-4B/rq4_cb512-512-512-512_sk0.0-0.0-0.0-0.003_kmtrue-lkmtrue-kmi100/Feb-10-2026_02-27-30/best_collision_model.pth}"
if [[ -z "$CKPT_PATH" ]]; then
