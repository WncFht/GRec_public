...
# --- 配置文件路径 ---
CONFIG_FILE=./config/qwen_lora_seqrec.yml
...
# 创建日志目录
LOG_DIR=./log/multimodal_finetune/qwen
mkdir -p $LOG_DIR
TIMESTAMP=$(date +%Y%m%d%H%M%S)
LOG_FILE="$LOG_DIR/lora_seqrec_${TIMESTAMP}.log"
...
nohup python3 -m src.finetune.multimodal_finetune_lora \
