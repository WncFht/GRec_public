...
BASE_MODEL=ckpt/Instruments/Qwen2-VL-7B-lora-item2index-seqrec-fusionseqrec-1-qwen7B-merged-old
# BASE_MODEL=ckpt/base_model/Qwen2-VL-7B-Instruct
MODEL_TYPE=qwen2_vl

DATA_PATH=./data
RATIO_DATASET=1
OUTPUT_DIR=ckpt/Instruments/Qwen2-VL-7B-lora-think-item2index-seqrec-fusionseqrec-1-qwen7B
...
nohup torchrun --nproc_per_node=4 --master_port=33325 -m src.finetune.train_ddp_vl_think \
    --seed 42 \
