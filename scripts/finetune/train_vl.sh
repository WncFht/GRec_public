...
BASE_MODEL=ckpt/base_model/llava-hf/llava-onevision-qwen2-7b-ov-hf
# BASE_MODEL=ckpt/Arts,Games,Instruments/Llava-onevision-emb-item2index-1-llama/checkpoint-19284
# BASE_MODEL=ckpt/Instruments/Llava-onevision-emb-item2index-1-qwen7B/checkpoint-212
