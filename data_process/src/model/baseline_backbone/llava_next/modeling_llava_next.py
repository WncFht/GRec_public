...
from transformers.models.llava_next.configuration_llava_next import (
    LlavaNextConfig,
)
...
class LlavaNextForConditionalGeneration(
    ...
    def _merge_input_ids_with_image_features(
        ...
        with torch.no_grad():
            ...
            if batch_size > 1:
                ...
                if _right_padding and left_padding:
                    left_padding = False
    ...
    @replace_return_docstrings(
        output_type=LlavaNextCausalLMOutputWithPast,
            ...
            if pixel_values.dim() == 5:
                ...
                _pixel_values_list = [
                    ...
                    for pix_val, num_patch in zip(
                        pixel_values, image_num_patches, strict=False
                    )
                ]
